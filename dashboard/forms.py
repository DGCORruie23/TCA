...
class RegistroConAccionesYPruebasForm(forms.ModelForm):
    ...
    accion1_descripcion = forms.CharField(widget=forms.Textarea)
    
    prueba1_nom_archivo = forms.CharField(max_length=100)
    prueba1_tipo = forms.ChoiceField(choices=Pruebas.types_archivo)
    prueba1_archivo_url = forms.CharField(max_length=100)
